...
python hw4_base.py -conv_size 7 3 3 -conv_nfilters 64 128 256 -hidden 128 64-dropout 0.5 -exp_index $SLURM_ARRAY_TASK_ID -epochs 1000 -L2_regularizer 0.01 -experiment_type 'basic' -dataset '/home/fagg/datasets/core50/core50_128x128' -network 'deep'